...
const liveProjects = [
  {
    ...
    progress: 65,
    currentMilestone: "Teacher Training Program",
  ...
  },
  {
    ...
    progress: 40,
    currentMilestone: "Batch 1 Training",
  ...
  },
  {
    ...
    progress: 52,
    currentMilestone: "Operations - Month 4",
  ...
  {
    id: 4,
    name: "Clean Water - Bundelkhand",
    ngo: "Jal Seva Trust",
    location: "Bundelkhand, UP",
    progress: 18,
    currentMilestone: "RO Plant Installation",
...
const alerts = [
  {
    ...
    message: "No update received for 6 days. Milestone deadline in 4 days.",
  },
  {
    level: "medium",
    project: "Women Empowerment Drive",
    message: "Batch 1 training 2 days behind schedule.",
  },
  {
    level: "low",
    project: "Rural Education Initiative",
    message: "Awaiting final beneficiary count from 3 schools.",
  },
];

const geoPhotos = [
  { label: "Patna - Classroom setup", coords: "25.59°N, 85.13°E" },
  { label: "Nashik - Health van", coords: "19.99°N, 73.78°E" },
  { label: "Jaipur - Training centre", coords: "26.91°N, 75.78°E" },
  { label: "Bundelkhand - Site survey", coords: "25.45°N, 78.57°E" },
];
    ...
    <>
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-[#64748b] text-sm mt-1">
              Real-time tracking of approved CSR projects across India.
            </p>
          </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            { label: "Active Projects", value: "24", icon: Activity, color: "text-[#0ea5e9]" },
            { label: "On Track", value: "19", icon: CheckCircle2, color: "text-[#10b981]" },
            { label: "Delayed", value: "3", icon: Clock, color: "text-[#f59e0b]" },
            { label: "Critical Alerts", value: "2", icon: AlertTriangle, color: "text-[#ef4444]" },
          ].map((s) => (
            <div
              key={s.label}
              className="bg-white rounded-2xl p-5 shadow-sm border border-[#e5e7eb] flex items-center justify-between"
            >
              <div>
            ...
            {alerts.map((a, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="font-semibold text-sm text-[#1a2847]">
                    {a.project}
                  </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-[#e5e7eb]">
            ...
            <div className="relative h-[400px] rounded-xl overflow-hidden bg-gradient-to-br from-[#0f1c3f] via-[#1a2847] to-[#0f1c3f] border border-[#2d3f6b]">
              ...
              {/* Fake pins */}
              {[
                { top: "35%", left: "55%", label: "Patna" },
                { top: "60%", left: "40%", label: "Nashik" },
                { top: "42%", left: "28%", label: "Jaipur" },
                { top: "38%", left: "48%", label: "Bundelkhand" },
                { top: "70%", left: "38%", label: "Bengaluru" },
              ].map((p, i) => (
                <div
                  key={i}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#e5e7eb]">
            ...
            <div className="grid grid-cols-2 gap-3">
              {geoPhotos.map((p, i) => (
                <div
                  key={i}
                  className="relative rounded-lg overflow-hidden aspect-square bg-gradient-to-br from-[#0ea5e9]/20 to-[#06b6d4]/10 border border-[#e5e7eb] flex items-center justify-center"
                >
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#e5e7eb]">
          ...
          <div className="space-y-4">
            {liveProjects.map((p) => (
              <div
                key={p.id}
                className="p-4 border border-[#e5e7eb] rounded-xl hover:bg-[#f8fafc] transition-all"
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-[#1a2847] w-10 text-right">
                    {p.progress}%
                  </span>
                </div>
              </div>
